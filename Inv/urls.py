...
from .views import CategoriaView,CategoriaNew,CategoriaEdit,CategoriaDel,SubCategoriaView,SubCategoriaNew,SubCategoriaEdit,MarcaView,MarcaNew,MarcaEdit,marca_inactivar,UMView,UMNew,UMEdit,ProductoView,ProductoNew,ProductoEdit,producto_inactivar
...
urlpatterns = [
     ...
     name='marca_new'),
     path('marcas/edit/<int:pk>',MarcaEdit.as_view(),
     name='marca_edit'),
     path('marcas/inactivar/<int:id>',marca_inactivar,
     name='marca_inactivar'),
     
     path('unidadmedidas/',UMView.as_view(),
     name='unidadmedida_list'),
     path('unidadmedidas/new',UMNew.as_view(),
     name='unidadmedida_new'),
     path('unidadmedidas/edit/<int:pk>',UMEdit.as_view(),
     name='unidadmedida_edit'),
     
     path('productos/',ProductoView.as_view(),
     name='producto_list'),
     path('productos/new',ProductoNew.as_view(),
     name='producto_new'),
